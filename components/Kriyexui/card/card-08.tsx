      ...
      <div className="parent">
        <div className="card">
          ...
          <div className="content">
            <span className="title">Red UI System</span>
            <span className="text">Modern 3D glass UI with motion depth</span>
          </div>
...
.logo .circle {
  ...
  background: "#ff4d6d";
  box-shadow:
    0px 10px 20px rgba(220, 38, 126, 0.3),
    0px 6px 6px rgba(220, 38, 126, 0.2);
  transition: all 0.6s ease-in-out;
}
  ...
  .parent:hover .card {
    ...
    box-shadow:
    rgba(220, 38, 38, 0.6) 0px 15px 30px,
    rgba(239, 68, 68, 0.4) 0px 0px 25px;
  }

  .parent:hover .card .bottom .social-buttons-container .social-button {
    transform: translate3d(0, 0, 60px);
    box-shadow: rgba(60, 30, 46, 0.25) 5px 20px 10px 0px;
  }
