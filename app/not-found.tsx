...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-2 overflow-hidden bg-neutral-100 dark:bg-neutral-950">
      {/* TV Illustration */}
      ...
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <Link
          href="/"
          className="group flex items-center gap-2 rounded-full px-5 py-2.5
      ...
      {/* Scoped CSS (original design preserved) */}
      <style jsx>{`
